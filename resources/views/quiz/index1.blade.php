          ...
          <div class="col-md-6">
            ...
            <div class="card card-info">
              ...
              <div class="card-body">
                ...
                <h5 class="mt-4 mb-2">{{$mcq->question}}</h5>

                <div class="row">
                  <div class="col-lg-6">
                    <div class="input-group">
                      <div class="input-group-prepend">
                        <span class="input-group-text"><input type="radio" name="option" value="1">{{$mcq->option1}}</span>
                      </div>
                    </div>
                    <!-- /input-group -->
                  </div>
                  ...
                  <div class="col-lg-6">
                    <div class="input-group">
                      <div class="input-group-prepend">
                        <span class="input-group-text"><input type="radio" name="option" value="2">{{$mcq->option2}}</span>
                      </div>
                    </div>
                    <!-- /input-group -->
                  </div>
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="input-group">
                      <div class="input-group-prepend">
                        <span class="input-group-text"><input type="radio" name="option" value="3">{{$mcq->option3}}</span>
                      </div>
                    </div>
                    <!-- /input-group -->
                  </div>
                  ...
                  <div class="col-lg-6">
                    <div class="input-group">
                      <div class="input-group-prepend">
                        <span class="input-group-text"><input type="radio" name="option" value="4">{{$mcq->option4}}</span>
                      </div>
                    </div>
                    <!-- /input-group -->
                  </div>
