...
<head>
  ...
  <title>Project Synergy | DataTables</title>
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <a class="btn btn-app" href="mcqs/create">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>{{$mcq->option1}}
                      ...
                      @else
                      <form method="POST" action="setanswer" class="form-horizontal">
                        @csrf
                        <input type="hidden" name="qid" value="{{$mcq->id}}">
                        <input type="hidden" name="answer" value="1">
                        <button type="submit" class="btn btn-info setAnswerBtn" >Set Answer</button>
                      </form>
                      @endif
