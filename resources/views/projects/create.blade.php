  ...
  <div class="content-wrapper">
                        ...
                        <form method="POST" action="{{ route('mcqs.store') }}" class="form-horizontal">
                            ...
                            <div class="card-body" id="maincard">
                                <div class="form-group row">
                                    <label for="question" class="col-sm-2 col-form-label">Project Title</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="question" placeholder="Project Title" name="question">
                                    </div>
                                    @error('question')
                                ...
                                <div class="form-group row">
                                    <label for="option1" class="col-sm-2 col-form-label">Project Description</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="option1" placeholder="Project Description" name="option1">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="option1" class="col-sm-2 col-form-label">Project Description</label>
                                ...
                                <div class="form-group row">
                                  <label for="phaseSelect" class="col-sm-2 col-form-label">Project</label>
                                    <div class="col-sm-10">
                                      <select class="form-control" id="phaseSelect">
                                      <option value="phase1">Project-1</option>
                                      <option value="phase2">Project-2</option>
                                      <option value="phase3">Project-3</option>
                                      </select>
                                    </div>
                                </div>
                            ...
                            <div class="form-group row">
                                    <div class="col-sm-10 offset-sm-2">
                                        <button type="button" class="btn btn-primary addEmailField">Add Another Email</button>
                                    </div>
                                </div>
                            <!-- /.card-body -->
    ...
    <script>
        $(function() {
            ...
            // Remove email field
            $('#emailFields').on('click', '.removeEmailField', function() {
